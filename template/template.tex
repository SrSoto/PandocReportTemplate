...
\newcommand{\uamlogo}{$logo$}
\newcommand{\uamlogoheader}{$logoheader$}
\newcommand{\fecha}{
	$if(date)$
	$date$
	$else$
...
\def\uamlogoscale{$if(logoscale)$$logoscale$$else$0.07$endif$}
\def\uamlogoheaderscale{$if(logoheaderscale)$$logoheaderscale$$else$0.04$endif$}
...
\newcommand{\logoa}{$if(logoa)$$logoa$$else$none.png$endif$}
\newcommand{\logob}{$if(logob)$$logob$$else$none.png$endif$}
\newcommand{\logoc}{$if(logoc)$$logoc$$else$none.png$endif$}
...
\includegraphics[scale=\logoascale]{\logoa}\\
&   \includegraphics[scale=\logobscale]{\logob}\\
& \includegraphics[scale=\logobscale]{\logoc}
\end{tabular}
