...
\newcommand{\subtitulo}{Proyecto de Ingeniería del Software}
...
\newcommand{\autora}{Carlos Molinero Alvarado}
\newcommand{\autorb}{Rafael Sánchez Sánchez}
\newcommand{\autorc}{Alejandro Santorum Varela}
\newcommand{\autord}{Manuel Soto Jiménez}
...
\definecolor{green_uam_1}{RGB}{108, 35, 13}
\definecolor{green_uam_2}{RGB}{162, 52, 19}
\definecolor{green_uam_3}{RGB}{238, 140, 110}
\definecolor{green_uam_4}{RGB}{244, 178, 159}
\definecolor{green_uam_5}{RGB}{249, 217, 207}
\definecolor{green_uam_6}{RGB}{255, 237, 227}
...
\lstdefinestyle{uamcode}{
    ...
    keywordstyle=\color{green_uam},
    numberstyle=\tiny\color{green_uam_1},
    stringstyle=\color{uam_green},
...
\begin{flushright}
    ...
    \fontsize{16}{12}\selectfont \today %% IMPORTANTE: FECHA
    \\
    \fontsize{12}{12}\selectfont Versión 1.0
\end{flushright}}
